...
export const Announcement = ({
    ...
    <BadgeContext.Provider value={{ themed }}>
        <Badge
            variant={variant}
            className={cn(
                'max-w-full gap-2 rounded-full bg-white px-3 py-0.5 font-medium shadow-sm transition-all hover:scale-[103%] hover:shadow-md cursor-pointer hover:mx-2',
                'hover:shadow-md',
...
export const AnnouncementTitle = ({
    ...
    <div
        className={cn(
            'flex items-center gap-1 truncate mx-auto text-sm font-regular',
            className
        )}
        {...props}
    />
